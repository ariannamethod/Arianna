...
- `SHORT_MSG_SKIP_PROB` – chance to ignore very short or non‑question messages (default 0.5).
...
Use the `/debugskip` command in chat to toggle skipping behavior at runtime.
