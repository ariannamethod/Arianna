...
Arianna is a Telegram bot built with [aiogram](https://docs.aiogram.dev/) that leverages OpenAI's Assistants API and several helper tools. The project runs a small webhook server to process updates from Telegram.
